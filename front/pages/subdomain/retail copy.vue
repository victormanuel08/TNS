<template>
  <div class="autopago-container">
    ...
    <header class="autopago-header">
      ...
      >
        ...
        <div class="logo-right">
          ...
          <div v-if="orderType" class="order-type-badges">
            <p 
      ...
      <!-- Búsqueda y controles integrados en el header -->
    ...
    <!-- Productos -->
    <div class="products-section" :class="{ 'columns-2': columnsCount === 2, 'columns-3': columnsCount === 3 }">
      <div 
      ...
      <div class="cart-sidebar" @click.stop>
        ...
        <div v-if="cart.length > 0" class="cart-footer-top">
          ...
          <div class="cart-actions-top">
            <button class="add-separator-btn" @click="addSeparator" title="Agregar Separador">
              ➕ Separador
            </button>
            ...
            <template v-else>
              <div class="cart-item-info">
                ...
                <div class="cart-item-details">
                  <h4>{{ item.name }}</h4>
                  <p v-if="item.nota && item.nota.trim() !== ''" class="cart-item-note">
                    📝 {{ item.nota }}
                  </p>
    ...
    <!-- Modal para editar nota del item -->
    <div v-if="editingNoteIndex !== null" class="modal-overlay" @click="closeNoteEditor">
      <div class="modal-content invoice-modal" @click.stop>
...
.autopago-container {
  ...
  padding: 1.5rem;
  padding-top: 4.5rem; /* Espacio para el banner de debug */
  max-width: 1400px;
  margin: 0 auto;
  width: 100%;
